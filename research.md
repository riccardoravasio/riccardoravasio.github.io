...
<section markdown="1">
  ...
  Errors stall replication and correcting these errors is faster than paying the associated time cost. So we found that kinetic proofreading and similar non-equilibrium error-correcting machineries can act as an overall speedup, not a slowdown. This suggests that selection for speed alone is enough to evolve elaborate error correction — even with no direct pressure on accuracy and no information to protect.
